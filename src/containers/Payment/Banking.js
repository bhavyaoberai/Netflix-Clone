  ...
  return (
    <div className="mx-auto w-70">
      <div className="w-full">
        {/* HDFC Bank */}
        <div className="flex items-center mb-4 font-semibold p-2 rounded shadow-md">
          <div className="w-20 border rounded-full p-3 m-3">
            <img
          ...
          <div className="w-70 text-left ml-10">
            <h3>HDFC Bank</h3>
          </div>
        </div>
...
// import React from "react";
// import BANKING from "./Styles/Banking.css";
