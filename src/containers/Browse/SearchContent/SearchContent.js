...
const SearchContent = props => {
    ...
    const getSearchMovies = async (searchItem) => {
        const movieUrl = `search/movie?api_key=637b8a23990f8a2a804e1bed5e53735d&language=en-US&query=${searchItem}&page=1&include_adult=false`
        const tvUrl = `search/tv?api_key=637b8a23990f8a2a804e1bed5e53735d&language=en-US&page=1&query=${searchItem}&include_adult=false`
